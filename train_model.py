...
def train():
    ...
    for epoch in range(epochs):
        ...
        for _, batch_data in enumerate(train_loader, 1):
            ...
            optimizer.zero_grad()
            history_feature, y, trajectory_len, user_graph, user_graph_edges, user_graph_weight, neighbor = spilt_batch(batch_data)
            y = y.to(device)
            ...
            y_pred = transformer(user_history_feature, global_graph_feature, global_dist_feature, user_graph_feature, src_mask, embed_neighbor)
